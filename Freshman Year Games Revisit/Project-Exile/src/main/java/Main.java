...
public class Main extends GameApplication
{
	...
	{
		Jukebox.playBGM("Ambiance 1.wav", 0.2);
	...
	public static void dungeon1() throws IOException
	{
		//Start the music
		Jukebox.stopBGM();
		Jukebox.playBGM("Cave-ish.wav", 0.2);
		...
		for(int i = 0; i < minionList.length; i++) {
			...
			if(minionList[i].getClass().getName().equals("Boss")) { 
				Jukebox.stopBGM();
				Jukebox.playBGM("Dungeon Minions.wav", 0.2);
	...
	{
		Jukebox.stopBGM();
		Jukebox.playBGM("Tension.wav", 0.2);
		...
		Jukebox.stopBGM();
		Jukebox.playBGM("Boss Minions.wav", 0.2);
		...
		for(int i = 0; i < minionList.length; i++) {
			...
			{
				Jukebox.stopBGM();
				Jukebox.playBGM("Real Villain.wav", 0.2);
	...
	public static void bossRush() throws IOException
	{
		...
		Jukebox.stopBGM();
		Jukebox.playBGM("Otto Van Bismarck.wav", 0.2);
