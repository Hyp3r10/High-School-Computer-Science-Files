import java.awt.*;
import java.applet.*;
public class GreenFrog extends KermitTheFrog
{
    public GreenFrog(Graphics g, Color gC1, Color gC2, Color gC3, Color gC4, Color gC5, Color gC6, Color gC7, 
                                 ...
                                 Color bC21, Color bC22)
    {
        ...
        super(g, gC1, gC2, gC3, gC4, gC5, gC6, gC7, wC1, wC2, wC3, wC4, wC5, 
                 ...
                 bC21, bC22);
        Arm arm = new Arm(g, gC1, gC2, gC3, gC4, gC5, gC6, gC7);
        Neck neck = new Neck(g, gC1, gC2, gC3, gC4, gC5, gC6, gC7);
        Body body = new Body(g, gC1, gC2, gC3, gC4, gC5, gC6, gC7);
    }
}